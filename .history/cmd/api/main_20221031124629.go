...
func main() {
	...
	flag.StringVar(&cfg.db.dsn, "dsn", "postgres://postgres:Somahhashi@3232@localhost/go_movies?sslmode=disable", "Postgres connection string")
	...
	cfg.jwt.secret = os.Getenv("GO_MOVIES_JW")
